...
export default function PaymentPendingPage() {
  ...
  useEffect(() => {
    ...
    if (orderId) {
      api.post('/payments/confirm', { orderId, paymentId, status: 'pending' }).catch(() => {});
    }
  }, []);
  ...
  return (
    <div style={styles.page}>
      <div style={styles.card}>
        ...
        <p style={styles.sub}>Tu pago está siendo procesado. Te avisaremos cuando se confirme.</p>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  card: { background: '#ffffff', border: '1px solid rgba(245,158,11,0.15)', borderRadius: '20px', padding: '48px 40px', maxWidth: '440px', width: '100%', textAlign: 'center' as const, boxShadow: '0 8px 40px rgba(0,0,0,0.08)' },
  iconWrap: { width: '64px', height: '64px', background: 'rgba(245,158,11,0.08)', border: '2px solid rgba(245,158,11,0.2)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.5rem', margin: '0 auto 20px' },
